...
const methodDescriptor_QuestionService_FindByID = new grpc.web.MethodDescriptor(
  ...
  proto.IDResponse,
  /**
   * @param {!proto.IDRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.IDResponse.deserializeBinary
);


/**
 * @param {!proto.IDRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.IDResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.IDResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.QuestionServiceClient.prototype.findByID =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/QuestionService/FindByID',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.IDResponse>}
 *     Promise that resolves to the response
 */
proto.QuestionServicePromiseClient.prototype.findByID =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/QuestionService/FindByID',
      request,
